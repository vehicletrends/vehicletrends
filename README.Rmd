...
Once loaded, all datasets are available directly by name. See the [package documentation site](https://pkg.vehicletrends.us/) for details on available datasets.
